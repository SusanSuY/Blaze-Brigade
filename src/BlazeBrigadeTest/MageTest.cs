...
namespace ModelTest
{
    namespace UnitModuleTest
    {
        ...
        public class MageTest
        {
            ...
            {
                Mage unit = new Mage(null, null, null, null, Vector2.Zero, null);
                unit.equippedWeapon = new Fireball();
                Assert.AreEqual(4, unit.Str);
            }
            ...
            public void getStats_ShouldReturnExpected()
            {
                ...
                Assert.AreEqual(4, stats[1]);
                Assert.AreEqual(6, stats[2]);
